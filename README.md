...
Download 39 Features Pickle File
Download 15 Features JOBlib File
...
Make sure to replace "39_features_link (https://drive.google.com/file/d/1YKAZEQ8-06UZSRCCKL8AwOVVzOR1Lws_/view?usp=drive_link)" and "15_features (https://drive.google.com/file/d/1RoqlrdjkHi7uo_yHdo-cAtb_h-z3S9iI/view?usp=drive_link )" with the actual download links for the respective files on Google Drive.



Sample test results for single domain: 
